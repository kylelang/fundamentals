...
| 7 | Logistic regression model assumptions and classification | Logistic regression model assumptions, classification, confusion matrix | Check the assumptions of your model and make adjustments if necessary. Make classifications | [Chapter 17 (only 17.4)](https://book.stat420.org/logistic-regression.html#generalized-linear-models) | 
