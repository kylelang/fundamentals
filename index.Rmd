...
[***Fundamental Techniques in Data Science with R***](https://osiris.uu.nl/osiris_student_uuprd/OnderwijsCatalogusSelect.do?selectie=cursus&cursus=201900026&collegejaar=2020&taal=en)
...
Workgroup Instructor: [Laura Boeschoten](https://www.uu.nl/medewerkers/LBoeschoten) <br>
Study load: 7.5 ECTS <br>
Assessment: Assignments and Exam <br>
[Course SurfDrive folder](https://surfdrive.surf.nl/files/index.php/s/IQ517X5UitVOayk)
...
a completion basis, and you must finish each exercise to pass the course.

To pass the course:

1. Your final grade must be 5.5 or higher
1. You must pass both assignments
1. You must submit all seven `R` exercises
...
submitted to the [Surfdrive file drop environment]((https://surfdrive.surf.nl/files/index.php/s/IQ517X5UitVOayk)). 
...
[`R` Exercise 1](Wk1/Exercise/Exercise_1_walkthrough.html) before the workgroup 
meeting!**
...
this week to get you up and running for the rest of the course.

- Complete [Exercise 1](wk1/exercise/exercise1_walkthrough.html) before 
Thursday's workgroup. This exercise will get you started with `R` and `RStudio`.

- Complete [Exercise 2](wk1/exercise/exercise2_walkthrough.html) during 
Thursday's workgroup meeting. Laura will be available to help you during that 
time. 

- Complete and submit [Exercise 3](wk1/exercise/exercise3_walkthrough.html) 
before the next lecture. For this week, you only need to present the `R` code 
for the relevant exercises.
