...
| Exam        | 2023-01-25<br>13:30 | Olympos<br>Hal<br>2     |
...
| 3 | Exploratory data analysis with `R` | Data visualization, data inspection, data cleaning and writing functions in `R` | **Hand in your individual assignment** Form groups, pitch your found data to your group, continue with data inspection and cleaning for the first assignment, formulate hypotheses | R4DS [Chapter 3](https://r4ds.had.co.nz/data-visualisation.html), [Chapter 7](https://r4ds.had.co.nz/exploratory-data-analysis.html) and [Chapter 19](Functions https://r4ds.had.co.nz/functions.html). ASWR [Chapter 4](https://book.stat420.org/summarizing-data.html) | 
| 4 | Multiple linear regression | Specifying linear models in `R` using the `lm()`function, model fit and model comparison, categorical predictors and moderation | Find a best fitting model, test your hypotheses | ASWR [Chapter 7 (only 7.1-7.4)](https://book.stat420.org/simple-linear-regression.html), [Chapter 9 (only 9.1-9.4)](https://book.stat420.org/multiple-linear-regression.html), [Chapter 11 (only 11.2 and 11.3)](https://book.stat420.org/categorical-predictors-and-interactions.html#interactions) and [Chapter 16 (only 16.1 (not 16.1.4.) and 16.2)](https://book.stat420.org/variable-selection-and-model-building.html).| 
| 5| Model assumptions and diagnostics | Assumptions of the linear model, leverage, outliers and influential points. | Check assumptions of your model and inspect for unusual observations. Make adjustments if necessary, draw conclusions. **Hand in Assignment 1** | ASWR [Chapter 13](https://book.stat420.org/model-diagnostics.html)|
| 6 | Generalized linear model, logistic regression | Specifying generalized linear models using the `glm()` function in `R `, logistic regression modelling definition, estimation and interpretations. | Perform data inspection and cleaning for the second assignment. Formulate hypothesis, find a best fitting model and test your hypotheses | ASWR [Chapter 17 (only 17.1-17.3)](https://book.stat420.org/logistic-regression.html#generalized-linear-models), [this webpage](https://stats.idre.ucla.edu/other/mult-pkg/faq/general/faq-how-do-i-interpret-odds-ratios-in-logistic-regression/)|
| 7 | Logistic regression model assumptions and classification | Logistic regression model assumptions, classification, confusion matrix | Check the assumptions of your model and make adjustments if necessary. Make classifications | [Chapter 17 (only 17.4)](https://book.stat420.org/logistic-regression.html#generalized-linear-models), [This webpage](https://stats.idre.ucla.edu/r/dae/logit-regression/) | 
| 8 | Summary, catch-up and questions | - | Interpret your final model as well as the confusion matrix. Draw conclusions **Hand in Assignment 2** | - | 
<!----------------------------------------------------------------------------->
...
You can find the suggested solutions to this exercise [here](preparation/exercise_prep_solutions.html).
...
The slides for this workgroup meeting can be found [here]().
...
practical.
  ...
  * Complete [Practical 1](wk1/practical/FTIDR_Practical_Week1_questions.html).
...
solutions. 
  ...
  * [Answers practical 1](wk1/practical/FTIDR_Practical_Week1_answers.html).
...
objects in `R`, performing basic data transformations and working with pipes.
  ...
  * Complete [Practical 2](wk2/practical/FTIDR_Practical_Week2_questions.html).
...
You can find suggested answers to the practical here:
  * [Answers practical 2](wk2/practical/FTIDR_Practical_Week2_answers.html).
...
cleaning and writing functions in `R`. 
  ...
  * Complete [Practical 3](wk3/practical/FTIDR_Practical_Week3_questions.html).
...
You can find suggested answers to the practical here:
  * [Answers practical 3](wk3/practical/FTIDR_Practical_Week3_answers.html).
...
more data visualization. 
  ...
  * Complete [Practical 4](wk4/practical/FTIDR_Practical_Week4_questions.html).
...
You can find suggested answers to the practical here:
  * [Answers practical 4](wk4/practical/FTIDR_Practical_Week4_answers.html).
...
model as well as checks for outliers and influential cases. 
  ...
  * Download the dataset to use for this exercise from [Surfdrive datasets](https://surfdrive.surf.nl/files/index.php/s/F6FtbuU1j0eq5Qf).
  * Complete [Practical 5](wk5/practical/FTIDR_Practical_Week5_questions.html).
...
You can find suggested answers to the practical here:
  * [Answers practical 5](wk5/practical/FTIDR_Practical_Week5_answers.html).
...
model as well as checks for outliers and influential cases. 
  ...
  * Complete [Practical 6](wk6/practical/FTIDR_Practical_Week6_questions.html).
...
You can find suggested answers to the practical here:
  * [Answers practical 6](wk6/practical/FTIDR_Practical_Week6_answers.html).
...
model as well as checks for outliers and influential cases. 
  ...
  * Complete [Practical 7](wk7/practical/FTIDR_Practical_Week7_questions.html).
...
You can find suggested answers to the practical here:
  * [Answers practical 7](wk7/practical/FTIDR_Practical_Week7_answers.html).
