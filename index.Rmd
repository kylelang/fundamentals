...
Thursday's workgroup meeting. This exercise will get you started with `R` and 
`RStudio`.
...
[SurfDrive](https://surfdrive.surf.nl/files/index.php/s/LqUCEt3MWVsW7DF) drop 
folder. Name the file `Yourname.R`, where `Yourname` is your name. Do this 
