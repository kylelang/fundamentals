...
| 3 | Linear model 1; Data visualization | The `lm()` function in `R`; Visualizing bivariate relations | Specify a linear model; Fit your defined model | [ISL][isl] 3.1 & 6.1, [Lecture Notes](http://www.mit.edu/~6.s085/notes/lecture3.pdf) |
...
| 5 | Model building; Prediction; Cross-validation | Tying the analytic pieces together into a full regression analysis | Evaluate and, if possible, improve your model; **Prepare Assignment 1; Evaluate the final linear model on your own data** | [ISL][isl] 5.1, [Document](wk5/literature/Example_CVlm.pdf), [Blog Post 1](https://thestatsgeek.com/2014/01/25/r-squared-and-goodness-of-fit-in-linear-regression/), [Blog Post 2](https://thestatsgeek.com/2013/10/28/r-squared-and-adjusted-r-squared/) |
...
through an exam analysis using logistic regression
