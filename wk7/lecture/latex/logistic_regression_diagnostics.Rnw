...
\begin{frame}[fragile, allowframebreaks]{Summaries of the Confusion Matrix}
  ...
  \begin{itemize}
    \item In our example, Accuracy = 0.78
    \item 78\% are correctly classified
  \end{itemize}
  ...
  \begin{itemize}
    \item In our example, Error Rate = 0.22
    \item 22\% are incorrectly classified
  \end{itemize}
  ...
  \begin{itemize}
    \item In our example, Sensitivity = 0.84
    \item 84\% of survivors are correctly classified
  \end{itemize}
  ...
  \begin{itemize}
    \item In our example, Specificity = 0.69
    \item 69\% of deaths are correctly classified 
  \end{itemize}
  ...
  \begin{itemize}
    \item In our example, FPR = 0.31
    \item 31\% of deaths are incorrectly classified as survivors
  \end{itemize}
  ...
  \begin{itemize}
    \item In our example, PPV = 0.81
    \item There is an 81\% chance that a passenger classified as a survivor was
  ...
  \begin{itemize}
    \item In our example, NPV = 0.73
    \item There is a 73\% chance that a passenger classified as dying was 
      classified correctly
  \end{itemize}
